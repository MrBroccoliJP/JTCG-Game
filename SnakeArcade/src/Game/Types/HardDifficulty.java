...
public class HardDifficulty extends BaseDifficulty {
     ...
     * Adds a mixture of 1xGoodOrb, 1xBonusOrb, 5xBadOrb and 1xRainbowOrb to the activeOrbs list.
     */
    @Override
